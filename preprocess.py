...
# def your data_dir
data_root = '../raw_data/MonoData/F001'
save_root = 'data_F001'
...
# save log-mel
print('save log-mel, f0, F1, F2...')
Parallel(n_jobs=-1)(delayed(save_logmel)(save_root, wav_name, wn2mel_new[wav_name], 'F001') for wav_name in tqdm(train_wavs_names))
